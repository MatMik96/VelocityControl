...
void PacketsClass::setToVelControl(unsigned char ID, unsigned char ON_OFF) {
  unsigned char VelControl[] = {
    HEADER,
    HEADER,
    HEADER_3,
    RESERVED,
    ...
    PACKET_LENGTH_H,
    WRITE_INSTRUCTION,
    VEL_CONTROL,            //Is put to 0x11
    0x00,
    ON_OFF,        //Control Mode
  };

  transmitInstructionPacket(VelControl, 11);
}
...
void PacketsClass::setGoalVelocityPacket(int vel, unsigned char ID) {
  ...
  unsigned char Velocity[] = {
    ...
    (vel & 0xFF),        //byte 1 of Data
    (vel & 0xFF00) >> 8,   //byte 2 of Data
    (vel & 0xFF0000) >> 16,  //byte 3 of Data
    (vel & 0xFF000000) >> 24,  //byte 4 of Data
  };
...
//Make packet for 0xFE stop of velocity
